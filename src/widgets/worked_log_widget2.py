...
class WorkedLogWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        with open(utils.get_absolute_resource_path('resources/csv_data/dict_pickle.pkl'), 'rb') as pickle_file:
            self.data_dictionary = pickle.load(pickle_file)

        # self.work_log_data = pandas.read_csv(utils.get_absolute_resource_path("resources/csv_data/log_data.csv"))
        self.work_log_data = pandas.read_csv(utils.get_absolute_resource_path("resources/csv_data/log_data.csv"))
        self.current_week_index_list2 = self.get_week_days_list(self.year, self.week)
        # print(self.data_dictionary[2019][8][5]['work_day'])
        self.current_week_index_list = self.work_log_data.loc[self.work_log_data['week'].isin([self.week])].index.values.astype(int)
        self.current_month_index_list = self.work_log_data.loc[self.work_log_data['month'].isin([self.month])].index.values.astype(int)
    ...
    def get_week_days_list(self, year, week):
        """
        ...
        dates = [[startdate.year, startdate.month, startdate.day]]
        for i in range(1, 7):
    ...
    def init_user_interface(self):
        ...
        # self.monday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[0]]['work_day'])
        self.monday_check_box.setChecked(self.data_dictionary[self.current_week_index_list2[0][0]][self.current_week_index_list2[0][1]][self.current_week_index_list2[0][2]]['work_day'])
        self.monday_check_box.stateChanged.connect(self.monday_checkbox_status_change)
        self.monday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[0]]['day'])
        self.monday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[0]]['work_in'])
        self.monday_checkin_label.setValidator(worked_time_validator)
        self.monday_checkin_label.setFixedSize(self.TIME_BOX_SIZE)
        self.monday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[0]]['work_day'])
        self.monday_checkin_label.textChanged.connect(self.calculate_monday_total_time)
        self.monday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[0]]['lunch_in'])
        ...
        self.monday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[0]]['work_day'])
        self.monday_lunch_checkin_label.textChanged.connect(self.calculate_monday_total_time)
        self.monday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[0]]['lunch_out'])
        ...
        self.monday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[0]]['work_day'])
        self.monday_lunch_checkout_label.textChanged.connect(self.calculate_monday_total_time)
        self.monday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[0]]['work_out'])
        self.monday_checkout_label.setValidator(worked_time_validator)
        self.monday_checkout_label.setFixedSize(self.TIME_BOX_SIZE)
        self.monday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[0]]['work_day'])
        self.monday_checkout_label.textChanged.connect(self.calculate_monday_total_time)
        self.monday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[0]]['total_time'])
        ...
        self.monday_morning_interjourney_status.setStyleSheet("background-color:" + self.work_log_data.iloc[self.current_week_index_list[0]]['status_one'])
        ...
        self.monday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[0]]['status_two'])
        ...
        self.monday_afternoon_interjourney_status.setStyleSheet("background-color:" + self.work_log_data.iloc[self.current_week_index_list[0]]['status_three'])

        self.tuesday_check_box = QCheckBox(text='Tue')
        self.tuesday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.tuesday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[1]]['work_day'])
        self.tuesday_check_box.stateChanged.connect(self.tuesday_checkbox_status_change)
        self.tuesday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[1]]['day'])
        self.tuesday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[1]]['work_in'])
        self.tuesday_checkin_label.setValidator(worked_time_validator)
        self.tuesday_checkin_label.setFixedSize(self.TIME_BOX_SIZE)
        self.tuesday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[1]]['work_day'])
        self.tuesday_checkin_label.textChanged.connect(self.calculate_tuesday_total_time)
        self.tuesday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[1]]['lunch_in'])
        ...
        self.tuesday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[1]]['work_day'])
        self.tuesday_lunch_checkin_label.textChanged.connect(self.calculate_tuesday_total_time)
        self.tuesday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[1]]['lunch_out'])
        ...
        self.tuesday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[1]]['work_day'])
        self.tuesday_lunch_checkout_label.textChanged.connect(self.calculate_tuesday_total_time)
        self.tuesday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[1]]['work_out'])
        ...
        self.tuesday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[1]]['work_day'])
        self.tuesday_checkout_label.textChanged.connect(self.calculate_tuesday_total_time)
        self.tuesday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[1]]['total_time'])
        ...
        self.tuesday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[1]]['status_one'])
        ...
        self.tuesday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[1]]['status_two'])
        self.tuesday_lunch_interjourney_status = QFrame()
        self.tuesday_lunch_interjourney_status.setFixedSize(self.COLOR_FRAME_SIZE)
        self.tuesday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[1]]['status_three'])

        self.wednesday_check_box = QCheckBox(text='Wed')
        self.wednesday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.wednesday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[2]]['work_day'])
        self.wednesday_check_box.stateChanged.connect(self.wednesday_checkbox_status_change)
        self.wednesday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[2]]['day'])
        self.wednesday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[2]]['work_in'])
        ...
        self.wednesday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[2]]['work_day'])
        self.wednesday_checkin_label.textChanged.connect(self.calculate_wednesday_total_time)
        self.wednesday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[2]]['lunch_in'])
        ...
        self.wednesday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[2]]['work_day'])
        self.wednesday_lunch_checkin_label.textChanged.connect(self.calculate_wednesday_total_time)
        self.wednesday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[2]]['lunch_out'])
        ...
        self.wednesday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[2]]['work_day'])
        self.wednesday_lunch_checkout_label.textChanged.connect(self.calculate_wednesday_total_time)
        self.wednesday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[2]]['work_out'])
        ...
        self.wednesday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[2]]['work_day'])
        self.wednesday_checkout_label.textChanged.connect(self.calculate_wednesday_total_time)
        self.wednesday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[2]]['total_time'])
        ...
        self.wednesday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[2]]['status_one'])
        ...
        self.wednesday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[2]]['status_two'])
        ...
        self.wednesday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[2]]['status_three'])

        self.thursday_check_box = QCheckBox(text='Thu')
        self.thursday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.thursday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[3]]['work_day'])
        self.thursday_check_box.stateChanged.connect(self.thursday_checkbox_status_change)
        self.thursday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[3]]['day'])
        self.thursday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[3]]['work_in'])
        ...
        self.thursday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[3]]['work_day'])
        self.thursday_checkin_label.textChanged.connect(self.calculate_thursday_total_time)
        self.thursday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[3]]['lunch_in'])
        ...
        self.thursday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[3]]['work_day'])
        self.thursday_lunch_checkin_label.textChanged.connect(self.calculate_thursday_total_time)
        self.thursday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[3]]['lunch_out'])
        ...
        self.thursday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[3]]['work_day'])
        self.thursday_lunch_checkout_label.textChanged.connect(self.calculate_thursday_total_time)
        self.thursday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[3]]['work_out'])
        ...
        self.thursday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[3]]['work_day'])
        self.thursday_checkout_label.textChanged.connect(self.calculate_thursday_total_time)
        self.thursday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[3]]['total_time'])
        ...
        self.thursday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[3]]['status_one'])
        ...
        self.thursday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[3]]['status_two'])
        self.thursday_lunch_interjourney_status = QFrame()
        self.thursday_lunch_interjourney_status.setFixedSize(self.COLOR_FRAME_SIZE)
        self.thursday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[3]]['status_three'])

        self.friday_check_box = QCheckBox(text='Fri')
        self.friday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.friday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[4]]['work_day'])
        self.friday_check_box.stateChanged.connect(self.friday_checkbox_status_change)
        self.friday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[4]]['day'])
        self.friday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[4]]['work_in'])
        self.friday_checkin_label.setValidator(worked_time_validator)
        self.friday_checkin_label.setFixedSize(self.TIME_BOX_SIZE)
        self.friday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[4]]['work_day'])
        self.friday_checkin_label.textChanged.connect(self.calculate_friday_total_time)
        self.friday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[4]]['lunch_in'])
        ...
        self.friday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[4]]['work_day'])
        self.friday_lunch_checkin_label.textChanged.connect(self.calculate_friday_total_time)
        self.friday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[4]]['lunch_out'])
        ...
        self.friday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[4]]['work_day'])
        self.friday_lunch_checkout_label.textChanged.connect(self.calculate_friday_total_time)
        self.friday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[4]]['work_out'])
        self.friday_checkout_label.setValidator(worked_time_validator)
        self.friday_checkout_label.setFixedSize(self.TIME_BOX_SIZE)
        self.friday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[4]]['work_day'])
        self.friday_checkout_label.textChanged.connect(self.calculate_friday_total_time)
        self.friday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[4]]['total_time'])
        ...
        self.friday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[4]]['status_one'])
        ...
        self.friday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[4]]['status_two'])
        self.friday_lunch_interjourney_status = QFrame()
        self.friday_lunch_interjourney_status.setFixedSize(self.COLOR_FRAME_SIZE)
        self.friday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[4]]['status_three'])

        self.saturday_check_box = QCheckBox(text='Sat')
        self.saturday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.saturday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[5]]['work_day'])
        self.saturday_check_box.stateChanged.connect(self.saturday_checkbox_status_change)
        self.saturday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[5]]['day'])
        self.saturday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[5]]['work_in'])
        ...
        self.saturday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[5]]['work_day'])
        self.saturday_checkin_label.textChanged.connect(self.calculate_saturday_total_time)
        self.saturday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[5]]['lunch_in'])
        ...
        self.saturday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[5]]['work_day'])
        self.saturday_lunch_checkin_label.textChanged.connect(self.calculate_saturday_total_time)
        self.saturday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[5]]['lunch_out'])
        ...
        self.saturday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[5]]['work_day'])
        self.saturday_lunch_checkout_label.textChanged.connect(self.calculate_saturday_total_time)
        self.saturday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[5]]['work_out'])
        ...
        self.saturday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[5]]['work_day'])
        self.saturday_checkout_label.textChanged.connect(self.calculate_saturday_total_time)
        self.saturday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[5]]['total_time'])
        ...
        self.saturday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[5]]['status_one'])
        ...
        self.saturday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[5]]['status_two'])
        self.saturday_lunch_interjourney_status = QFrame()
        self.saturday_lunch_interjourney_status.setFixedSize(self.COLOR_FRAME_SIZE)
        self.saturday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[5]]['status_three'])

        self.sunday_check_box = QCheckBox(text='Sun')
        self.sunday_check_box.setLayoutDirection(Qt.LeftToRight)
        self.sunday_check_box.setChecked(self.work_log_data.iloc[self.current_week_index_list[6]]['work_day'])
        self.sunday_check_box.stateChanged.connect(self.sunday_checkbox_status_change)
        self.sunday_week_day_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[6]]['day'])
        self.sunday_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[6]]['work_in'])
        self.sunday_checkin_label.setValidator(worked_time_validator)
        self.sunday_checkin_label.setFixedSize(self.TIME_BOX_SIZE)
        self.sunday_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[6]]['work_day'])
        self.sunday_checkin_label.textChanged.connect(self.calculate_sunday_total_time)
        self.sunday_lunch_checkin_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[6]]['lunch_in'])
        ...
        self.sunday_lunch_checkin_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[6]]['work_day'])
        self.sunday_lunch_checkin_label.textChanged.connect(self.calculate_sunday_total_time)
        self.sunday_lunch_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[6]]['lunch_out'])
        ...
        self.sunday_lunch_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[6]]['work_day'])
        self.sunday_lunch_checkout_label.textChanged.connect(self.calculate_sunday_total_time)
        self.sunday_checkout_label = QLineEdit(text=self.work_log_data.iloc[self.current_week_index_list[6]]['work_out'])
        self.sunday_checkout_label.setValidator(worked_time_validator)
        self.sunday_checkout_label.setFixedSize(self.TIME_BOX_SIZE)
        self.sunday_checkout_label.setEnabled(self.work_log_data.iloc[self.current_week_index_list[6]]['work_day'])
        self.sunday_checkout_label.textChanged.connect(self.calculate_sunday_total_time)
        self.sunday_worked_time_label = QLabel(text=self.work_log_data.iloc[self.current_week_index_list[6]]['total_time'])
        ...
        self.sunday_morning_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[6]]['status_one'])
        ...
        self.sunday_afternoon_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[6]]['status_two'])
        self.sunday_lunch_interjourney_status = QFrame()
        self.sunday_lunch_interjourney_status.setFixedSize(self.COLOR_FRAME_SIZE)
        self.sunday_lunch_interjourney_status.setStyleSheet("background-color:"+self.work_log_data.iloc[self.current_week_index_list[6]]['status_three'])
